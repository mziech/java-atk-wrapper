...
public class AtkTableCellImpl extends AtkTableImpl implements AtkTableCell {
  ...
  public AtkTableCellImpl(AccessibleContext ac) {
    super(ac);
    this.ac = ac;
 ...
 */
  ...
  public AccessibleTable getTable() {
    debug("Get Table: %s", acc_table_cell.toString());
