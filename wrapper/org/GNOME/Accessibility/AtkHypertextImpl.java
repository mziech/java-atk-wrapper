...
public class AtkHypertextImpl extends AtkTextImpl implements AtkHypertext {

	AccessibleHypertext acc_hyper_text;

	public AtkHypertextImpl(AccessibleContext ac) {
		super(ac);
	...
	public AtkHyperlink get_link (int link_index) {
		if (acc_hyper_text != null) {
			...
			if (link != null) {
				return AtkFactory.synchronize(new AtkHyperlinkImpl(link));
			}
		}
